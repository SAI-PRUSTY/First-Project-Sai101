...
<select name="cars" id="cars" style="width: 100%" "height: 30px">
  <option value="volvo">Have you identified vehicle?*</option>
...
<label class="form-label" for="form3Example4c">Select Your Proffession</label>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="form3Example3c">Estimate value of the vehicle that you're buying</label>
                    </div>
                  </div>

                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="contactdetails3.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color:lightpink">NEXT</button></a>
