  ...
  <div class="container-fluid ">
    <div class="row">
      <div class=" col col-md-2 " style="text-align: justify;">
        <h1>Commercial Vehicle loan</h1><br>
        <nav>
...
<label class="form-label" for="form3Example4c">Select Your Requirement</label>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                   ...
                   <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="file" id="form3Example3c" class="form-control" placeholder="Adhaar Number" />
                      <label class="form-label" for="form3Example3c">Your Driving Licence details are protected and kept safe with us</label>
                    </div>
                  </div>
                   ...
                   <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="file" id="form3Example3c" class="form-control" placeholder="Adhaar Number" />
                      <label class="form-label" for="form3Example3c">Your Bank Passbook are protected and kept safe with us</label>
                    </div>
                  </div>

                 <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="loanoffer3.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color:lightpink">NEXT</button></a>
