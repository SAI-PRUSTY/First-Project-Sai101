...
<label class="form-label" for="form3Example4c">Select Your Requirement</label>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="file" id="form3Example3c" class="form-control" placeholder="DL Number" />
                 ...
                 <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="loanoffer2.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color:lightpink">NEXT</button></a>
