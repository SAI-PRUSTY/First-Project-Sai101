          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1"><table><tr>
                ...
                <td><p class="text-center h5 fw-bold mb-5 mx-1 mx-md-4 mt-4">We want to know you better so that we can customizeour car loan for you</p></td>
               </tr> </table>
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="form3Example3c">No. of years in your current Company/Business </label>
                    </div>
                  </div>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="propertydetails2.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color: lightpink">NEXT</button></a>
                  </div>
