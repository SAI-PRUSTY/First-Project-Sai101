      ...
      <div class="col-lg-12 col-xl-11">
        <div class="card text-black" style="border-radius: 15px;">
          <div class="card-body p-md-5">
            ...
            <table>
              <tr>
              <td><div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                <img src="image/goldloan3.jpeg" class="img-fluid" alt="Sample image" width="900px" height="900px" >

              </div></td>

              <td><div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                <img src="image/goldloan4.jpeg" width="900px" height="900px" class="img-fluid" alt="Sample image">

              </div></td>
              <td><div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                <img src="image/goldloan5.jpeg" width="900px" height="900px" class="img-fluid" alt="Sample image">
