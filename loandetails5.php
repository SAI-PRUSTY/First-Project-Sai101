          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1"><table><tr>
                ...
                <td><p class="text-center h3 fw-bold mb-5 mx-1 mx-md-4 mt-4">Hi, I am sai come to the Home loan management</p></td>
               </tr> </table>
...
<label class="form-label" for="form3Example4c">Select Your Requirement</label>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="incomedetails.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color:lightpink">NEXT</button></a>
