          ...
          <div class="card-body p-md-5">
            ...
            <table>
              ...
              <td><div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="image/loan23.png" width="450%" height="450%" class="img-fluid" alt="Sample image">

              </div></td>

              <td><div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                <img src="image/loan24.webp" width="450%" height="450%" class="img-fluid" alt="Sample image">
