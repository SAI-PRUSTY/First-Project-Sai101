          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1"><table><tr>
                ...
                <td><p class="text-center h3 fw-bold mb-5 mx-1 mx-md-4 mt-4">Hi, I am sai come to the Gold loan management</p></td>
               </tr> </table>
...
<select name="cars" id="cars" style="width: 100%; height:30px;">
  ...
  <option value="saab">Home Loan Balance Transfer</option>
  <option value="mercedes">Loan Against Property</option>
  <option value="audi">Home Construction Loan</option>
</select>
<label class="form-label" for="form3Example4c">Select Your Requirement</label>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="incomedetails1.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color:lightpink">NEXT</button></a>
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="image/goldloan1.jpeg" class="img-fluid" alt="Sample image" width="100%">
