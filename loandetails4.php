...
<select name="cars" id="cars" style="width: 100%" "height: 30px" >
  ...
  <option value="volvo">Graduate</option>
  <option value="saab">Post Graduate</option>
  <option value="other">Others Education</option>
 </select><br>
<label class="form-label" for="form3Example4c">Select Your Complete Edocation</label>
                    </div>
                  </div>
...
<select name="cars" id="cars" style="width: 100%; height:30px;">
  ...
  <option value="saab">B.Tech</option>
  <option value="mercedes">MCA</option>
  <option value="audi">M.Tech</option>
  <option value="audi">M.Com</option>
  <option value="audi">other Higher Education</option>
</select>
<label class="form-label" for="form3Example4c">Select Your Requirement</label>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="incomedetails4.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color:lightpink">NEXT</button></a>
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="image/loan21.jpeg" class="img-fluid" alt="Sample image">
