                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="form3Example3c">Percentage of Previous class</label>
                    </div>
                  </div>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                   <a href="propertydetails4.php"> <button type="button" class="btn btn-primary btn-lg" style="background-color: lightpink">NEXT</button></a>
                  </div>
